...
<div class="box">
    ...
    <p>服务器IP：115.47.68.96</p>
    <p>当前网站语言：UTF-8简体中文</p>
    <p>公司网站：<a href="http://www.pigcms.com" class="blue">公司网站</a></p>
    <p>系统版本：<?php if($updateRecord.version): ?>20140615<?php else: ?>暂无版本记录<?php endif; ?>&nbsp;&nbsp;<a href="?g=System&m=System&a=checkUpdate" class="blue">检查更新并在线升级</a> <?php if($canEnUpdate != 1): ?><span style="color:red;font-weight:bold"></span><?php endif; ?></p>
    <p style="display:none">数据库版本： <a href="?g=System&m=System&a=checkUpdate" class="blue">检查更新并在线升级</a></p>
    </div>
    <ul class="myinfo">
   <li><p class="red">您的程序版本为：PigCms6.3.1</p><span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[ 授权版本:商业版 (终身使用权) ]</span></li>
   <li style="display:none"><p class="red" style="display:none">您的程序版本为：PigCms6.3多用户微信营销系统</p><span style="display:none">[ 授权版本：商业版 (终身免费) ]</span></li>
