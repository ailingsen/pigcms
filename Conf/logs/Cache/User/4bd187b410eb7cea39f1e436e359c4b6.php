...
<div class="cLineB">
 ...
 <div class="cLineB">
<div class="pageNavigator left"><strong>此相册地址：<a href="<?php echo ($f_siteUrl); ?>/index.php?g=Wap&m=Photo&a=plist&token=<?php echo ($token); ?>&id=<?php echo ($_GET['id']); ?>" class="green"><?php echo ($f_siteUrl); ?>/index.php?g=Wap&m=Photo&a=plist&token=<?php echo ($token); ?>&id=<?php echo ($_GET['id']); ?></a></strong></div>
<div class="clr"></div>
</div>
