...
<div class="tab" >
<ul >
<li class="<?php if(ACTION_NAME == 'index' AND ($type == 'semester')): ?>current<?php endif; ?> tabli classty"  id="tab0"><a href="<?php echo U('School/index',array('token'=>$token ,'type'=>'semester'));?>">学期管理</a></li>
<li class="<?php if(ACTION_NAME == 'index' AND ($type == 'theclass')): ?>current<?php endif; ?> tabli classty" id="tab0"><a href="<?php echo U('School/index',array('token'=>$token ,'type'=>'theclass'));?>">班级管理</a></li>
<li class="<?php if(ACTION_NAME == 'index' AND ($type == 'score')): ?>current<?php endif; ?> tabli classty" id="tab0"><a href="<?php echo U('School/index',array('token'=>$token,'type'=>'score'));?>">成绩管理</a></li>
<li class="<?php if(ACTION_NAME == 'index' AND ($type == 'subject')): ?>current<?php endif; ?> tabli classty" id="tab0"><a href="<?php echo U('School/index',array('token'=>$token,'type'=>'subject'));?>">科目管理</a></li>
<li class="<?php if(ACTION_NAME == 'index' AND ($type == 'timeframe')): ?>current<?php endif; ?> tabli classty"id="tab0"><a href="<?php echo U('School/index',array('token'=>$token,'type'=>'timeframe'));?>">时段管理</a></li>
<li class="<?php if(ACTION_NAME == 'index' AND ($type == 'week')): ?>current<?php endif; ?> tabli classty" id="tab0"><a href="<?php echo U('School/index',array('token'=>$token,'type'=>'week'));?>">星期管理</a></li>
