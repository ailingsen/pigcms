...
<div class="content">
<div class="cLineB">
  <h4>当前位置：微学校 >> <a href="<?php echo U('School/assess',array('token'=>$token));?>">教师管理</a> >> 课程添加</h4>
 </div>
      ...
      <form class="form" id="formID" method="post" action="" target="_top" enctype="multipart/form-data">
        ...
        <table class="userinfoArea" style=" margin:0;" border="0" cellspacing="0" cellpadding="0" width="100%">
            ...
            <tr>
                    ...
                    <td>
                        <h1><span class="maroon"><?php echo ($teachers['tname']); ?></span></h1>
                    </td>
            </tr>
            <tr>
                ...
                <tr>
                   <th><?php if($tcourse['id'] != ''): ?><input type="text" hidden name="id" value="<?php echo ($tcourse['id']); ?>"><?php endif; ?></th>
                   <input type="text" name="tid" value="<?php echo ($teachers['tid']); ?>" hidden>
                    <td>
