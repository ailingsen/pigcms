...
E_D("replace into `tp_function` values('43','4','0','抽奖','lottery','抽奖,输入抽奖即可参加幸运大转盘','1','1');");
...
E_D("replace into `tp_function` values('42','4','0','幸运大转盘','choujiang','输入抽奖　即可参加幸运大转盘抽奖活动','2','1');");
...
E_D("replace into `tp_function` values('44','4','0','刮刮卡','gua2','刮刮卡抽奖活动','1','1');");
E_D("replace into `tp_function` values('45','4','0','全景','panorama','','1','1');");
E_D("replace into `tp_function` values('46','4','0','婚庆喜帖','wedding','','2','1');");
E_D("replace into `tp_function` values('47','4','0','投票','vote','','2','1');");
E_D("replace into `tp_function` values('48','4','0','房产','estate','','2','1');");
E_D("replace into `tp_function` values('49','4','0','3G相册','album','','1','1');");
E_D("replace into `tp_function` values('50','4','0','砸金蛋','GoldenEgg','','2','1');");
E_D("replace into `tp_function` values('51','4','0','水果机','LuckyFruit','','2','1');");
E_D("replace into `tp_function` values('52','4','0','留言板','message','','2','1');");
E_D("replace into `tp_function` values('53','4','0','微汽车','car','','2','1');");
E_D("replace into `tp_function` values('54','4','0','微信墙','wall','','1','1');");
E_D("replace into `tp_function` values('55','4','0','摇一摇','shake','','1','1');");
E_D("replace into `tp_function` values('56','4','0','微论坛','forum','','1','1');");
E_D("replace into `tp_function` values('57','4','0','微医疗','medical','','1','1');");
E_D("replace into `tp_function` values('58','4','0','群发消息','message','','1','1');");
E_D("replace into `tp_function` values('59','4','0','分享统计','share','','1','1');");
E_D("replace into `tp_function` values('60','4','0','酒店宾馆','hotel','','1','1');");
E_D("replace into `tp_function` values('61','4','0','微教育','school','','1','0');");
E_D("replace into `tp_function` values('62','4','0','照片墙','Zhaopianwall','活动开启后，在聊天窗口中直接发送图片，即可图片上墙！','2','1');");
E_D("replace into `tp_function` values('63','4','0','微名片','Vcard','微名片','2','1');");
E_D("replace into `tp_function` values('64','4','0','高级模板','advanceTpl','高级模板','2','1');");
E_D("replace into `tp_function` values('65','1','0','','','','1','1');");
